...
## Added in the 2026-07-31 Daily Refresh

Update on 2026-07-31: refreshed local Claude Design-style skills, prompt-to-artifact design workspaces, Azure architecture diagram tooling, deterministic PDF generation, PDF extraction MCP support, data-to-report skills, search-to-slide/mind-map skills, chart MCP servers, diagnostic-report MCP workflows, and all-in-one content generation skills from official GitHub repositories, product pages, README evidence, and GitHub metadata. This pass added baoyu-design, Open CoDesign, Azure Architecture Diagram Builder, Emboss, StudyBros, pdf-mcp, data-analysis-skill, Felo AI CLI and Skills, Highcharts MCP Server, Predictive Maintenance MCP, and AnyGen Suite Skill. The targeted scraper ran only against these new records; author-blog/tracking links, a contributing guide, and a generic Open Graph image were scrubbed from the pdf-mcp research record before merging.

- [baoyu-design](https://github.com/JimLiu/baoyu-design): portable Agent Skill for running a Claude Design-style local workflow in Cursor, Claude Code, Codex, and other file-capable agents to produce self-contained HTML prototypes, dashboards, wireframes, landing pages, mobile apps, and decks.
- [Open CoDesign](https://github.com/OpenCoworkAI/open-codesign): local-first desktop app and Claude Design alternative that turns prompts into prototypes, slide decks, marketing assets, HTML, PDF, PPTX, ZIP, and Markdown with BYOK or imported Claude Code/Codex provider configs.
- [Azure Architecture Diagram Builder](https://github.com/Arturo-Quiroga-MSFT/azure-architecture-diagram-builder): AI-powered Azure architecture design app and MCP server for editable topology diagrams, whiteboard-style blueprint diagrams, cost estimates, Well-Architected checks, deployment guides, and IaC outputs.
- [Emboss](https://github.com/GGChamp85/Emboss): pure-Python document engine and optional MCP workflow for deterministic, accessible, print-ready PDFs from declarative specs, Markdown, or LLM-generated structure, including tables, charts, SVG, diagrams, embedded data, and diff/review loops.
- [StudyBros](https://github.com/Kirneill/StudyBros): MCP server and web app that ingests learning materials and generates flashcards, quizzes, practice tests, summaries, mastery tracking, and JSON/Anki/Markdown exports.
- [pdf-mcp](https://github.com/jztan/pdf-mcp): MCP server for large-PDF search, page reading, OCR, table/image extraction, chart-data extraction, rendered pages, corpus search, SQLite caching, and hidden-text trust flags.
- [data-analysis-skill](https://github.com/dongzhang84/data-analysis-skill): Claude Code skill for CSV/Excel analysis that produces narrative HTML reports, interactive charts, expert-synthesized findings, structured data profiles, and PowerPoint decks.
- [Felo AI CLI and Skills](https://github.com/Felo-Inc/felo-skills): CLI and Claude Code skill suite for real-time search, web fetch, YouTube subtitles, X search, style libraries, prompt/file-to-PPT generation, mind maps, landing pages, and API-backed research.
