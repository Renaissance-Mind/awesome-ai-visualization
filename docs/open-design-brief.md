...
- Include a live demo/example preview panel sourced from official homepage, demo, showcase, video, tutorial, and example URLs captured in `data/tool-research.yml`.
